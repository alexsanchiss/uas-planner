...
import type { DenialMapContentProps } from './DenialMapContent'

const DenialMapContent = dynamic<DenialMapContentProps>(
  () => import('./DenialMapContent'),
  { ssr: false }
)
...
export function DenialMapModal({ open, onClose, uplan, authorizationMessage, geoawarenessData }: DenialMapModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title={t.flightPlans.denialMapTitle} maxWidth="4xl">
      ...
      {/* Map */}
      <DenialMapContent
        operationVolumes={operationVolumes}
        geozonePolygons={geozonePolygons}
        center={center}
        allCoords={allCoords}
