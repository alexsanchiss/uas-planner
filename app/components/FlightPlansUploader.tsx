  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col gap-6">
            ...
            <div className="mt-4 p-4 bg-[var(--surface-primary)] rounded-lg border border-[var(--border-primary)] fade-in">
              ...
              {(selectedPlan.authorizationStatus === 'aprobado' || selectedPlan.authorizationStatus === 'denegado' || selectedPlan.authorizationStatus === 'withdrawn') && (
                <div className="mt-4 flex flex-col gap-2">
                  ...
                  {/* View SCRS alternative button or "No alternative found" message */}
                  {selectedPlan.authorizationStatus === 'denegado' &&
                    (() => {
                      ...
                      const isValidAlternative = parseScrsAlternative(msgStr) !== null
                      const hasFailedAlternative = hasFailedScrsAlternative(msgStr)
                      ...
                      if (hasFailedAlternative) {
                        return (
                          <div className="w-full px-4 py-2 text-sm font-semibold text-red-600 bg-red-50 border border-red-200 dark:bg-red-900/10 dark:border-red-800 dark:text-red-400 rounded-lg flex items-center justify-center gap-2">
                            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <UplanFormModal
        ...
        hasCsvResult={!!selectedPlan?.csvResult}
