...
export default function HowItWorksPage() {
  return (
    <main className="max-w-3xl mx-auto py-12 px-4">
      <h1 className="text-3xl font-bold mb-6 text-[var(--color-primary)]">How It Works</h1>
      <section className="mb-10 bg-[var(--surface-primary)] border border-[var(--border-primary)] rounded-lg shadow p-6 text-[var(--text-primary)]">
        <h2 className="text-2xl font-bold mb-2 text-[var(--color-primary)]">Getting Started</h2>
        <ol className="list-decimal ml-6 space-y-2 text-lg">
          ...
          <li>
            ...
            <ul className="list-disc ml-6 text-base mt-1">
              ...
              <li>Statuses are color-coded: <span className="text-[var(--processing-idle-text)]">Unprocessed</span>, <span className="text-[var(--processing-queued-text)]">Queued</span>, <span className="text-[var(--processing-active-text)]">Processing</span>, <span className="text-[var(--processing-completed-text)]">Processed</span>, <span className="text-[var(--processing-error-text)]">Error</span>.</li>
              <li>Use drag-and-drop or file selection to upload new plans directly into folders.</li>
            </ul>
          </li>
          <li>
            <span className="font-semibold text-[var(--color-primary)]">Organize and Manage:</span>
            <ul className="list-disc ml-6 text-base mt-1">
          ...
          <li>
            <span className="font-semibold text-[var(--color-primary)]">Explore More:</span>
            <ul className="list-disc ml-6 text-base mt-1">
      ...
      <section className="mb-10 bg-[var(--surface-primary)] border border-[var(--border-primary)] rounded-lg shadow p-6 text-[var(--text-primary)]">
        <h2 className="text-2xl font-bold mb-2 text-[var(--color-primary)]">How does trajectory generation work?</h2>
        <p className="mb-4">
        ...
        <p className="mt-2 text-[var(--text-secondary)] text-sm">You can read the full papers by clicking the links above.</p>
      </section>
    </main>
  );
}
