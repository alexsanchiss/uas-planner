...
% Compute the distance between two points within a few millimeters 
% of accuracy using the WGS-84 Earth ellipsoid.
% Compute forward azimuth, and compute backward azimuth, all using
% a vectorized version of Vincenty's algorithm.
%
...
if nargout > 1
    ...
    a12(lat1tr <= -90) = 0;
    a12(lat1tr >= 90 ) = pi;
    a12 = reshape(a12 * 57.2957795130823,keepsize); % to degrees
end
if nargout > 2
    a21=NaN*lat1;
    ...
    a21(lat2tr >= 90) = pi;
    a21(lat2tr <= -90) = 0;
    a21 = reshape(a21 * 57.2957795130823,keepsize); % to degrees
end
return
