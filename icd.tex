...
\begin{itemize}
    ...
    \item \textbf{Versión de la aplicación}: \texttt{v2.2.0 SPIRIT} (Sprints 1--4: 35 funcionalidades, proxy SSE de Geoawareness, visores 3D completos, gestión de usuario, sistema de contacto, restricciones EU, borradores U-Plan, visor Geoawareness 3D).
