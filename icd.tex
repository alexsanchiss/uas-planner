...
\title{ SPIRIT \\ \small{ICD - V\_{2.1.0}}}
...
\begin{itemize}
    \item \textbf{Versión del ICD}: \texttt{V\_2.1.0}.
    \item \textbf{Versión de la aplicación}: \texttt{v2.1.0 SPIRIT} (versión de producción con gestión de emails, importación de UPLANs externos y mejoras de robustez).
